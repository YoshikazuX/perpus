  ...
  <div class="main">
    ...
    <div class="content">
      <div class="form-container loan-form-wrapper">
        ...
        <form action="peminjaman_tambah_aksi.php" method="POST" class="loan-form-grid">
          ...
          <div class="form-group full-row">
            ...
            <input type="date" id="tgl_mulai" value="<?= htmlspecialchars($tanggalHariIni, ENT_QUOTES, 'UTF-8'); ?>" readonly>
          </div>
