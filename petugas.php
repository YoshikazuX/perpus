...
if ($keyword !== '') {
    $whereClause = " WHERE ID_PETUGAS LIKE '%$keywordEscaped%'
...
$pagination = getPaginationData($koneksi, "SELECT COUNT(*) AS total FROM petugas$whereClause");
$data = mysqli_query($koneksi, "SELECT * FROM petugas$whereClause ORDER BY ID_PETUGAS DESC LIMIT {$pagination['per_page']} OFFSET {$pagination['offset']}");
?>
    ...
    <div class="main">
        ...
        <div class="content">
            ...
            <div class="tombol-tambah">
                <?php renderSearchForm('Cari data petugas...'); ?>
